    ...
    <body>
        ...
        <div id="wrapper" class="container">
            <div id="page">
                <div id="map"></div>
                <div id="content">                   
                    <form id="carona" method="post">
                        <div class="form-group has-feedback">
                            <input type="text" class="form-control" id="start" name="partida" value="${requestScope.carona.getOrigem()}" disabled/>
                            <span class="glyphicon glyphicon-arrow-up form-control-feedback"></span>
                        </div>
                        <div class="form-group has-feedback">
                            <input type="text" id="end" class="form-control" name="destino" value="${requestScope.carona.getDestino()}" disabled/>
                            <span class="glyphicon glyphicon-arrow-down form-control-feedback"></span>
                        </div>
                        <div class="form-group has-feedback">
                            <input type="text" id="waypoint" class="form-control" name="waypoint" value="${requestScope.carona.getWayPoint()}" disabled/>
                            <span class="glyphicon glyphicon-exclamation-sign form-control-feedback"></span>
                        </div>
                        <div class="form-group has-feedback">
                            <input type="tel" class="form-control" name="telefone" value="${requestScope.carona.getTelUsuario()}" disabled/>
                                <span class="glyphicon glyphicon glyphicon-phone-alt form-control-feedback"></span>
                        </div>
                        <div class="form-group has-feedback">
                            <input type="date" class="form-control" name="data-partida" value="${requestScope.carona.getDataPartida()}" disabled/>
                            <span class="glyphicon glyphicon-calendarform-control-feedback"></span>
                        </div>
                        <div class="form-group has-feedback">
                            <input type="datetime" class="form-control" name="hora-partida" value="${requestScope.carona.getHoraPartida()}" disabled/>
